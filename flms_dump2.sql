...
DROP INDEX flms.unique_schema_migrations;
DROP INDEX flms.index_users_on_reset_password_token;
DROP INDEX flms.index_users_on_email;
ALTER TABLE ONLY flms.users DROP CONSTRAINT users_pkey;
ALTER TABLE ONLY flms.subscribers DROP CONSTRAINT subscribers_pkey;
ALTER TABLE ONLY flms.point_of_interests DROP CONSTRAINT point_of_interests_pkey;
ALTER TABLE ONLY flms.icons DROP CONSTRAINT icons_pkey;
ALTER TABLE ONLY flms.events DROP CONSTRAINT events_pkey;
ALTER TABLE ONLY flms.categories DROP CONSTRAINT categories_pkey;
ALTER TABLE flms.users ALTER COLUMN id DROP DEFAULT;
ALTER TABLE flms.subscribers ALTER COLUMN id DROP DEFAULT;
ALTER TABLE flms.point_of_interests ALTER COLUMN id DROP DEFAULT;
ALTER TABLE flms.icons ALTER COLUMN id DROP DEFAULT;
ALTER TABLE flms.events ALTER COLUMN id DROP DEFAULT;
ALTER TABLE flms.categories ALTER COLUMN id DROP DEFAULT;
DROP SEQUENCE flms.users_id_seq;
DROP TABLE flms.users;
DROP SEQUENCE flms.subscribers_id_seq;
DROP TABLE flms.subscribers;
DROP TABLE flms.schema_migrations;
DROP SEQUENCE flms.point_of_interests_id_seq;
DROP TABLE flms.point_of_interests;
DROP SEQUENCE flms.icons_id_seq;
DROP TABLE flms.icons;
DROP SEQUENCE flms.events_id_seq;
DROP TABLE flms.events;
DROP SEQUENCE flms.categories_id_seq;
DROP TABLE flms.categories_events;
DROP TABLE flms.categories;
DROP SCHEMA public;
DROP SCHEMA flms;
--
-- Name: flms; Type: SCHEMA; Schema: -; Owner: -
--
...
--
-- Name: categories; Type: TABLE; Schema: flms; Owner: -; Tablespace: 
--
...
--
-- Name: categories_events; Type: TABLE; Schema: flms; Owner: -; Tablespace: 
--
...
--
-- Name: categories_id_seq; Type: SEQUENCE; Schema: flms; Owner: -
--
...
--
-- Name: categories_id_seq; Type: SEQUENCE OWNED BY; Schema: flms; Owner: -
--
...
--
-- Name: categories_id_seq; Type: SEQUENCE SET; Schema: flms; Owner: -
--
...
--
-- Name: events; Type: TABLE; Schema: flms; Owner: -; Tablespace: 
--
...
--
-- Name: events_id_seq; Type: SEQUENCE; Schema: flms; Owner: -
--
...
--
-- Name: events_id_seq; Type: SEQUENCE OWNED BY; Schema: flms; Owner: -
--
...
--
-- Name: events_id_seq; Type: SEQUENCE SET; Schema: flms; Owner: -
--

SELECT pg_catalog.setval('events_id_seq', 483, true);


--
-- Name: icons; Type: TABLE; Schema: flms; Owner: -; Tablespace: 
--
...
--
-- Name: icons_id_seq; Type: SEQUENCE; Schema: flms; Owner: -
--
...
--
-- Name: icons_id_seq; Type: SEQUENCE OWNED BY; Schema: flms; Owner: -
--
...
--
-- Name: icons_id_seq; Type: SEQUENCE SET; Schema: flms; Owner: -
--
...
--
-- Name: point_of_interests; Type: TABLE; Schema: flms; Owner: -; Tablespace: 
--
...
--
-- Name: point_of_interests_id_seq; Type: SEQUENCE; Schema: flms; Owner: -
--
...
--
-- Name: point_of_interests_id_seq; Type: SEQUENCE OWNED BY; Schema: flms; Owner: -
--
...
--
-- Name: point_of_interests_id_seq; Type: SEQUENCE SET; Schema: flms; Owner: -
--

SELECT pg_catalog.setval('point_of_interests_id_seq', 340, true);


--
-- Name: schema_migrations; Type: TABLE; Schema: flms; Owner: -; Tablespace: 
--
...
--
-- Name: subscribers; Type: TABLE; Schema: flms; Owner: -; Tablespace: 
--
...
--
-- Name: subscribers_id_seq; Type: SEQUENCE; Schema: flms; Owner: -
--
...
--
-- Name: subscribers_id_seq; Type: SEQUENCE OWNED BY; Schema: flms; Owner: -
--
...
--
-- Name: subscribers_id_seq; Type: SEQUENCE SET; Schema: flms; Owner: -
--

SELECT pg_catalog.setval('subscribers_id_seq', 16, true);


--
-- Name: users; Type: TABLE; Schema: flms; Owner: -; Tablespace: 
--
...
--
-- Name: users_id_seq; Type: SEQUENCE; Schema: flms; Owner: -
--
...
--
-- Name: users_id_seq; Type: SEQUENCE OWNED BY; Schema: flms; Owner: -
--
...
--
-- Name: users_id_seq; Type: SEQUENCE SET; Schema: flms; Owner: -
--
...
--
-- Name: id; Type: DEFAULT; Schema: flms; Owner: -
--
...
--
-- Data for Name: categories; Type: TABLE DATA; Schema: flms; Owner: -
--
...
--
-- Data for Name: categories_events; Type: TABLE DATA; Schema: flms; Owner: -
--
...
--
-- Data for Name: events; Type: TABLE DATA; Schema: flms; Owner: -
--
...
441	Flooding in Yemen	Flooding in Yemen has led to 19 reported deaths, said the Yemeni Meteorology Center on Sunday. The Yemeni meteorology center warned of more heavy rains to come, especially in mountainous regions including Sana'a, Amran, Mahweet, Dhamar and Raima.	15.351582000000001	44.207318999999998	2013-04-02 21:19:00	2013-04-02 21:29:09.042382	2013-04-02 21:41:36.631144	http://www.yementimes.com/en/1664/news/2174/Flooding-continues-death-toll-rises.htm		Yellow	16	2013-04-02 21:19:00	2013-05-01 21:19:00		6	t	t
...
--
-- Data for Name: icons; Type: TABLE DATA; Schema: flms; Owner: -
--
...
--
-- Data for Name: point_of_interests; Type: TABLE DATA; Schema: flms; Owner: -
--
...
--
-- Data for Name: schema_migrations; Type: TABLE DATA; Schema: flms; Owner: -
--
...
--
-- Data for Name: subscribers; Type: TABLE DATA; Schema: flms; Owner: -
--
...
--
-- Data for Name: users; Type: TABLE DATA; Schema: flms; Owner: -
--
...
1	greese@digitalglobe.com	$2a$10$TIdVx57WzHNgYBt7iFvXouIW1dNKFtD8SNkMgdlXatAo.j5mnbejm	\N	\N	2013-04-22 14:36:49.073481	282	2013-05-02 19:46:31.639636	2013-04-29 19:35:46.617109	10.132.17.10	10.132.17.10	2011-05-26 15:29:01.822368	2013-05-02 19:46:31.640919
4	aolson@digitalglobe.com	$2a$10$4OgLh/xq7wwiTeAto60OJ.Wf024K5TMec.rWXk5HmcpRM0e.L9/aq	\N	\N	\N	73	2013-05-02 20:03:53.75627	2013-04-30 16:02:25.833664	10.132.17.10	10.132.17.10	2012-11-27 19:30:44.63277	2013-05-02 20:03:53.760113
\.


--
-- Name: categories_pkey; Type: CONSTRAINT; Schema: flms; Owner: -; Tablespace: 
--
...
--
-- Name: events_pkey; Type: CONSTRAINT; Schema: flms; Owner: -; Tablespace: 
--
...
--
-- Name: icons_pkey; Type: CONSTRAINT; Schema: flms; Owner: -; Tablespace: 
--
...
--
-- Name: point_of_interests_pkey; Type: CONSTRAINT; Schema: flms; Owner: -; Tablespace: 
--
...
--
-- Name: subscribers_pkey; Type: CONSTRAINT; Schema: flms; Owner: -; Tablespace: 
--
...
--
-- Name: users_pkey; Type: CONSTRAINT; Schema: flms; Owner: -; Tablespace: 
--
...
--
-- Name: index_users_on_email; Type: INDEX; Schema: flms; Owner: -; Tablespace: 
--
...
--
-- Name: index_users_on_reset_password_token; Type: INDEX; Schema: flms; Owner: -; Tablespace: 
--
...
--
-- Name: unique_schema_migrations; Type: INDEX; Schema: flms; Owner: -; Tablespace: 
--
...
--
-- Name: flms; Type: ACL; Schema: -; Owner: -
--
