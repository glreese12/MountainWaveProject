ContextServices::Application.configure do
  ...
  config.action_controller.cache_store = :file_store, "/dg/local/cache"
  #config.action_controller.page_cache_directory = "/dg/local/cache"
  ...
  HOST = "tu00gcsapp001.digitalglobe.com:8081"
  ...
  BASE_URL = "http://#{HOST}"
  DEFAULT_MAIL_TO = "flms@digitalglobe.com"
